...
Once that is compiled, you'd probably want to run `./luna.exe -h` in a command prompt (Windows) or `./luna -h` (Linux, MacOS, and UNIX-like systems), to get help on how to use Luna.
